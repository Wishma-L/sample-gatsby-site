...
const CommentSection = () => {
  return (
    <>
      <span className="flex place-content-around align-center">
        <span className="flex w-32 place-content-around">
          <svg width="28" height="28" viewBox="0 0 24 24" aria-label="clap">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
