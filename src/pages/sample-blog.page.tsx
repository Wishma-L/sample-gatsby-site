          ...
          <div className={styles.info}>
            ...
            <div className={styles.author}>
              ...
              <div className={styles.authorInfo}>
                <div className={styles.authorName}><a href="https://codepen.io/lucagez">Luca Gesmundo</a></div>
                <div className={styles.authorSub}>Nov 7 <span className="median-divider">·</span> 5 min read</div>
              </div>
            </div><a href="https://github.com/lucagez/medium.css" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star lucagez/medium.css on GitHub">Star</a>
          </div>
        </div>
        {/* The content */}
        <main className={styles.article}>
          <p>
            <span className={styles.blogTemplatefirstLetter}>W</span>eb Typography obsessed me. As many others,
          ...
          <p>
            <span className={styles.blogTemplatefirstLetter}>C</span>omes out that nothing is better than a big first letter to super-charge your style.
          ...
          <p>We all know who the leader is.<br />When designing a website you have to take into account fonts for three sectors: the <strong>content</strong>, the <strong>UI</strong>, the <strong>brand</strong>.<br />Specifically I found that the best free alternatives <i>(Google Fonts)</i> to the handcrafted fonts that <strong>Medium</strong> uses are respectively <span className="highlighted">Lora</span>,
            <span className={styles.highlighted}>Montserrat</span> and <span className="highlighted">Playfair Display</span>.<br />I discovered with delight that the last one mimics almost perfectly the effect created especially for <code>blockquote</code>.
          </p>
          <h2>Content font</h2>
          <p>
          ...
          <p>
            ...
            but not distracting from the main purpose of the page. <span className="highlighted">Reading!</span><br />You can use it also for <code>h2</code> making the titles for your paragraphs. Here the color should be the same as the one used for the main title.
          </p>
          <h2><span className={styles.highlighted}>The highlight</span></h2>
          ...
          <h1>Every Title</h1>
          <p className={styles.subtitle}>`Needs a subtitle`</p>
          ...
          <h2>Conclusion</h2>
          <p>As always, the strict first rule of design is that there are no strict rules.<br />But, if you are in trouble...</p>
          <blockquote>Use Medium.css ✍️</blockquote><br /><br />
          <p>Let me know what are your toughts about Web Typography, I am eager to hear from you!</p>
          <p>
            Happy readings,<br /><i><a href="https://codepen.com/lucagez">Gez</a></i></p><a className="styles.github-button" href="https://github.com/lucagez/medium.css" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star lucagez/medium.css on GitHub">Star</a>
        </main>
      </div>
    </>
  )
